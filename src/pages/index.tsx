...
const HomePage = () => {
  return (
    <Box>
      {/* Hero section */}
      <Element name="home">
        <Container className=" relative flex justify-center !mt-35 mb-20 min-h-[600px] lg:h-screen">
          <Flex
            data-aos="fade-up"
            as="section"
            direction="column"
            ...
            <Heading
              ...
              Powering Sustainable Animal Nutrition through Innovation and
              Nature
            </Heading>
            <Text className="text-center font-montserrat font-medium md:text-sm text-gray-400 !my-5 md:max-w-2xl">
              We transform organic waste into high-protein, eco-friendly feed
              for poultry, fish, and pigs, thus, creating climate-smart value
              chains and sustainable farming systems
            </Text>
            <Button
              rounded="full"
              fontSize="xs"
      ...
      <Element name="products">
        <Container>
          ...
          <Flex
            ...
            <Box className="w-full md:w-1/2 overflow-hidden rounded-4xl">
              <img
                src={FertilizerImg}
        ...
        <Container>
          <Box as="section" my={20}>
            ...
            <Text maxW="4xl" className="text-lg text-[#616060]">
              At Eco Protin, we are committed to transforming agriculture
              through innovative, sustainable solutions. Our services are
              designed to empower farmers, enhance productivity, and promote
          ...
          <Box as="section" my={20}>
            ...
            <Flex
              ...
              <Box className="w-full md:w-1/2">
                ...
                <Text className="text-base text-[#616060] mt-2">
                  ...
                  both household and community levels. To supplement their
                  income and help reduce the carbon footprint of the poultry
                  sector, our Waste4Cash program targets women-led poultry farms
                  and youth across the poultry value chain. Through this
                  initiative, participants actively engage in the aggregation
                  and valorization of poultry waste, turning waste into economic
                  opportunity-earning no less than $100 each month as part of
                  our shared commitment to environmental sustainability and
                  inclusive growth.
                </Text>
              </Box>
              <Box
                data-aos="fade-up"
                data-aos-delay="300"
                className="w-full md:w-1/2 h-[300px] rounded-4xl">
                <img
                  src={Waste4CashImg}
            ...
            <Box>
              ...
              <Text maxW="4xl" className="text-base text-[#616060] mt-2">
                These are decentralized, community-based access points where
                local livestock and fish farmers receive affordable BSF feed and
            ...
            <Flex
              ...
              <Box
                data-aos="fade-up"
                data-aos-delay="300"
                className="w-full md:w-1/2 h-[200px] rounded-4xl">
                <img
                  src={BlogImg}
                  alt="Waste4Cash Project"
                  className="!w-full !h-full object-cover rounded-4xl"
            ...
            <Box>
              ...
              <Text className="text-base text-[#616060] mt-2">
                We are a dynamic team of scientists, entrepreneurs, and
                grassroots changemakers committed to building a future where
                farming and nature thrive in harmony. Our strength lies in our
                diverse backgrounds, shared vision, and hands-on experience
                across agriculture, business, and sustainability.
              </Text>
              <br />
              <Text className="text-base text-[#616060] mt-2">
                ...
                Protin. With a Bachelor's degree in Psychology from the
                University of Cape Coast and postgraduate training in Marketing,
                Kwabena has led marketing and communication efforts across
                industries including radio journalism, automotive lubricants,
                real estate, insurance, and facilities management. At Eco
                Protin, he spearheads brand strategy, stakeholder engagement,
                and overall business development. <br />
              ...
              <br />
              <Text className="text-base text-[#616060] mt-2">
                Together, we are ably supported by a technical team comprising
                an entomologist, a crop scientist, and an animal nutritionist,
                whose expertise anchors the scientific rigor of our processes.
                In addition, we maintain strategic partnerships with key
                institutions in the agribusiness sector, ensuring we stay
                connected, collaborative, and forward-thinking in delivering
                scalable solutions. <br />
                At Eco Protin, we combine deep local insight with global
                thinking to create impact-driven solutions that promote circular
                agriculture, empower underserved communities, and contribute to
            ...
            <Flex
              ...
              <Box className="w-full md:w-1/2">
                ...
                <Text maxW="xl" className="md:text-lg text-[#616060]">
                  ...
                  <ul className="list-disc !pl-5 !text-base">
                    <li>
                      Sustainability: Zero-waste, low-emission models aligned
                      with SDG Goal1 of No Poverty,Goal 2 of Zero Hunger, and
